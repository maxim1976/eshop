...
🚀 **Production URL**: https://eshop-production-8a1d.up.railway.app  
🔗 **Port**: 8080  
🏢 **Platform**: Railway.com Metal Edge
...
```bash
# Essential Variables
SECRET_KEY=89gzrsrj40tw!qdwxtxt6vhp95!aog2h8@rmr7@vk*#lek8=!1
DEBUG=False
DJANGO_SETTINGS_MODULE=eshop.settings.production
RAILWAY_ENVIRONMENT=production
NIXPACKS_PYTHON_VERSION=3.10

# Database (use your actual Railway PostgreSQL URL)
DATABASE_URL=postgresql://postgres:lAljkuzMrvOdlmYAtgaSddmbwosCnwQr@postgres.railway.internal:5432/railway
...
PORT=8080 (auto-generated)
```

### ⚠️ **Important Railway PostgreSQL Info:**
- **Internal URL**: `postgres.railway.internal:5432`
- **Public URL**: `yamabiko.proxy.rlwy.net:13209`
- **Use the internal URL** in Railway environment variables
...
1. ✅ Visit https://eshop-production-8a1d.up.railway.app/health/ - should return `{"status": "healthy", "service": "eshop"}`
2. ✅ Check homepage loads correctly
3. ✅ Verify language switching works (Traditional Chinese/English)
